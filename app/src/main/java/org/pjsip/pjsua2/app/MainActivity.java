...
//        if (proxies.size() > 0) { etProxy.setText(proxies.get(0)); } else { etProxy.setText(""); }
...
//                               int expiration) {
//        String msg_str = "";
//        if (expiration == 0) { msg_str += "Unregistration"; } else { msg_str += "Registration"; }
//
//        if (code.swigValue() / 100 == 2) { msg_str += " successful"; } else {
